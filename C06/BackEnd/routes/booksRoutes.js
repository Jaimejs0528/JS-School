...
exports.bookRoutes = function bookRoutes(app) {
  ...
  app.patch('/bookshelf/books/digitals/lends', userController.isLogin, bookController.getDigitals); // Gets books in digital
  ...
  app.post('/bookshelf/books',  bookController.addOneBook); // Add a new book
